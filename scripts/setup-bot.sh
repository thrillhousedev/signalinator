...
BOTS=(        "conductinator"                        "decisionator"                          "informationator"                   "helpinator"              "helpinator2"              "newsinator"                            "summarizinator"              "taginator"                    "transcribinator")
BOT_DESCS=(   "Docker container management via Signal" "Loomio integration for polls/decisions" "RAG document Q&A (Ollama + ChromaDB)" "Signal help desk with ticketing"  "Signal help desk with ticketing (2)" "RSS/Reddit/Bluesky feed aggregation" "AI-powered chat summaries" "@mention all group members"  "Audio/video transcription (Whisper)")
