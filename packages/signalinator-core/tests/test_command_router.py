...
class TestCommandRouter:
    ...
    def test_route_sends_warning_reaction_on_failed_send(self, sample_command, sample_group_message):
        """Test routing sends ⚠️ when send_response fails."""
        router = CommandRouter()
        router.register_command(sample_command)
        ...
        result = router.route(
            context,
            lambda msg: False,  # simulate send failure
            lambda reaction: reactions.append(reaction) or True,
        )
