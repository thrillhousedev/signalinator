...
class TaginatorBot(SignalinatorBot):
    ...
    def _get_help_text(self) -> str:
        ...
        return (
            ...
            "📢 Tagging\n"
            "@mention - Tag everyone (works anywhere in a message)\n"
            "/tag - Same as @mention\n\n"
            "⚙️ Control (Admin)\n"
            "/pause - Pause tagging\n"
    ...
    def handle_group_message(
        ...
        Any @mention of the bot triggers tagging everyone.
        Commands like /help are already routed by the base bot before reaching here.
        """
