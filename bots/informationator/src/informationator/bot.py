...
class InformationatorBot(SignalinatorBot):
    ...
    def _get_help_text(self) -> str:
        ...
        return (
            "Informationator - Document Q&A\n\n"
            "📚 Ask Questions\n"
            "/ask <question> - Ask about documents\n"
            "@mention <question> - Ask via mention\n\n"
            "📄 Documents\n"
            "/docs list - List indexed documents\n"
            "/docs delete <id> - Remove a document\n"
            "@mention + attachment - Upload document\n\n"
            "📊 Status\n"
            "/kb-status - Knowledge base stats\n"
