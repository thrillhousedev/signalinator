...
@click.option('--phone', envvar='SIGNAL_PHONE_NUMBER', required=True, help='Phone number')
@click.option('--config-dir', envvar='SIGNAL_CLI_CONFIG_DIR', default='/signal-cli-config', help='Signal-CLI config directory')
@click.option('--name', default='helpinator', help='Name for this linked device')
...
@cli.command()
@click.option('--phone', envvar='SIGNAL_PHONE_NUMBER', required=True, help='Phone number')
@click.option('--db-path', envvar='DB_PATH', default='/data/helpinator.db', help='Database path')
...
def daemon(phone, db_path, auto_accept_invites):
    """Run Helpinator daemon with real-time relay."""
    click.echo("Starting Helpinator daemon...")
