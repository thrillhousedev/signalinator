"""Ollama API client for Snackinator — reused pattern from summarizinator."""
...
class OllamaClient:
    ...
    def __init__(self, host: str = None, model: str = None):
        ...
        self.model = model or os.getenv("SNACKINATOR_OLLAMA_MODEL") or os.getenv("OLLAMA_MODEL", self.DEFAULT_MODEL)
