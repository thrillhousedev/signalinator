...
class RelayEngine:
    ...
    def forward_dm_to_control(
        ...
        # Capture timestamp BEFORE sending for more accurate relay mapping
        # Note: This is still an approximation. For exact timestamps, the
        # Signal client would need to return the actual message timestamp.
        ...
        if success:
            ...
            logger.info(f"Forwarded DM to control room")
    ...
    def forward_direct_dm_to_control(
        ...
        if success:
            ...
            logger.info(f"Forwarded direct DM to control room")
    ...
    def handle_member_joined(
        ...
        # Capture timestamp BEFORE sending for more accurate reply routing
        notification_timestamp = int(time.time() * 1000)
